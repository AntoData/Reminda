...
class QuestionCreation(SimpleWindow):
    ...
    def single_answer_display(self):
        ...
        self.frame2.pack()
        self.button_save = tk.Button(self.frame2, text="Save", state=tk.DISABLED)
    ...
    def check_button_save_question(self, event):
        print("NEW ONE")
        print(self.question_filled())
        print(self.check_correct_number_checked())
        print(self.all_answers_filled_in())
    ...
    def __init__(self, title):
        ...
        self.question_text.bind("<Key>", self.check_button_save_question)
